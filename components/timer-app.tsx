...
export function TimerApp() {
  ...
  // Ask for notification permission once, after first interaction.
  useEffect(() => {
  ...
  // username, or this device has never signed in and is offline. Either way
  // the timer works — the local store keys state by an anonymous id until the
  // user signs in, at which point `setIdentity` merges the orphaned sessions
  // into their account (see claimOrphaned). We no longer block on identity.
